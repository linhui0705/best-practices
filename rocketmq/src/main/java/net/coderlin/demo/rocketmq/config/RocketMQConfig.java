package net.coderlin.demo.rocketmq.config;

import net.coderlin.demo.rocketmq.listener.SimpleMQConsumeBListener;
import net.coderlin.demo.rocketmq.listener.SimpleMQConsumeListener;
